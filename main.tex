...
$I(\bm{\theta}, \nu)$, where the two angular dimensions translate to the
transverse distances on the sky plane, and the spectral dimension
represents the line-of-sight distance.
