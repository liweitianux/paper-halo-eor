...
\end{equation}
where $n_{\R{th}}$ is the thermal electron number density (see below)
...
high-energy electrons to be accelerated \emph{in situ} by turbulence.
