...
The next-generation SKA\footnote{SKA: Square Kilometre Array;
  \url{https://skatelescope.org/}} \citep{koopmans2015}
...
is the overwhelming foreground pollution, which is generally 4--5 orders of
magnitude in strength with respect to the target EoR signals.
...
\begin{itemize}
  \item bright: $\sim\,$2--3 orders of magnitude stronger than the EoR signals;
