...
contributed by radio halos from galaxy clusters in the framework of
EoR detection.
...
radio sky, including the radio halos from galaxy clusters, the Galactic
...
We quantitatively evaluate the contamination of radio halos on EoR detection
and discuss the results in \autoref{sec:results},
