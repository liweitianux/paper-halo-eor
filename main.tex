...
{\color{cyan}%
\noindent
The overwhelming foreground contamination is the primary impediment to
probing the Epoch of Reionization (EoR) through measuring the redshifted
21~cm signal.
...
the EoR signal in three frequency bands.
...
same Fokker-Planck equation but with the turbulent acceleration disabled,}
