...
and \editone{%
$f_{\R{gas}}$ is the gas mass fraction that is given by \cite{ettori2015}
\begin{equation}
  \label{eq:fgas}
  f_{\R{gas}} = 0.110 \left[
    \frac{E(z) M_{\R{vir}}}{\SI{5e14}{\solarmass}} \right]^{0.198} ,
\end{equation}
where $E(z)$ is the redshift evolution factor [see \autoref{eq:hubble-z}].}
