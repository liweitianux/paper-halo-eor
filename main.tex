...
from which the one-dimensional power spectra are calculated and show that
radio halos can be about \numlist{e4;e3;e2} times more luminous than the
EoR signal on scales of $\SI{0.1}{\per\Mpc} < k < \SI{2}{\per\Mpc}$
in the \numrange{120}{128}, \numrange{154}{162}, and \numrange{192}{200}
...
$\SI{0.5}{\per\Mpc} \lesssim k \lesssim \SI{1}{\per\Mpc}$ can still be about
...
foreground sources and need careful treatments in future EoR experiments.
} % cyan
