...
%%%%%
\TODO{to finish the remaining results and discussions ...}

Besides the above analyses on radio halos by utilizing the typical example ...

Furthermore, we calculate the 1D power spectra ...

%========================================================================
\subsection{Other Frequency Bands}
\label{sec:freq-bands}
%========================================================================

Two frequency bands at \SIrange{120}{128}{\MHz} and \SIrange{192}{200}{\MHz}
...
Frequency structures due to calibration imperfections / observational effects.

Calibration errors/imperfections: \SI{\sim 0.1}{\percent} \citep{barry2016}.
The satisfactory performance of traditional per-frequency antenna calibration
depends on a highly accurate calibration catalog, i.e., foreground model.

%========================================================================
\subsection{Subtraction Requirements}
\label{sec:subtraction}
%========================================================================

Discuss the subtraction requirement of radio halos to make robust EoR detection.

%%%
\hrulefill

%% conclusions / summary ???
Most powers of the EoR signal are distributed at the low-\klos{} modes,
where the foreground contamination is strong.
Better understanding and characterizing the powerful foreground help
subtract the foreground more accurately, expanding the EoR window and
